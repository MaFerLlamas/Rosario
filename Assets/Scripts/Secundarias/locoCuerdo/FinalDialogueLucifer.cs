...
public class FinalDialogueLucifer : MonoBehaviour
{
    ...
    private void startDialogue()
    {
        ...
        if (Environment.habloLuciferMundoAbierto) dialogueLines = dialogueLines2;
        lineIndex = 0;
        Time.timeScale = 0f;
    ...
    private void nextDialogueLine()
    {
        ...
        else
        {
            ...
            Time.timeScale = 1f;
            Environment.habloLuciferMundoAbierto = true;
        }
    }
